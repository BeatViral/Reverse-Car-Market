    ...
    <section className="section-pad bg-ice">
      <Container>
        <SectionHeader
          ...
          description="This seller post was created from real vehicle details."
        />
        <div className="mt-8 grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="grid h-fit gap-3">
            ...
            <p className="rounded-lg bg-amber/10 p-4 text-sm font-bold leading-6 text-charcoal/72 ring-1 ring-amber/20">
              This is not a buyer post. It is a dealer-created seller post.
            </p>
          </div>
          <form className="rounded-lg bg-white p-6 shadow-card ring-1 ring-charcoal/10" onSubmit={(event) => { event.preventDefault(); setSubmitted(true); }}>
            {submitted ? (
              <div className="rounded-lg bg-green/10 p-5">
                ...
                <p className="mt-2 text-sm leading-6 text-charcoal/70">A buyer-interest record was created. If selected, a buyer post would be generated for the buyer to confirm.</p>
              </div>
            ) : null}
            ...
            <div className="mt-5 grid gap-3">
              ...
              <label className="flex items-center gap-2 text-sm font-bold text-navy">
                <input type="checkbox" defaultChecked /> Turn this into a buyer post
              </label>
            </div>
            <div className="mt-6">
