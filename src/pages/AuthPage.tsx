...
const roleOptions: Array<{ role: UserRole; title: string; text: string }> = [
  { role: 'buyer', title: 'Buyer', text: 'Post what you want and compare seller responses.' },
  { role: 'private_seller', title: 'Private Seller', text: 'Find public buyer demand and respond with your car.' },
  { role: 'dealer', title: 'Dealer', text: 'Upload inventory, publish seller posts and respond to buyer demand.' },
];
