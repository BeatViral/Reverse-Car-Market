...
const features = [
  ...
  [MessageSquareReply, 'Respond to Buyer Wanted Cards', 'Reply only when your stock genuinely fits what a buyer requested.'],
        ...
        <Container className="grid items-center gap-10 lg:grid-cols-[0.95fr_1.05fr]">
          <div>
            ...
            <p className="mt-5 text-lg leading-8 text-white/70">
              Turn inventory into buyer-interest cards, respond to real Buyer Wanted Cards and build a lead pipeline around demand instead of impressions.
            </p>
        ...
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <div className="mt-8 grid gap-3">
              {['Upload CSV, spreadsheet or paste inventory', 'Generate Dealer Match Cards', 'Receive buyer-interest leads', 'Respond to Buyer Wanted Cards', 'Founding dealer badge', 'Discounted subscription after pilot'].map((item) => (
