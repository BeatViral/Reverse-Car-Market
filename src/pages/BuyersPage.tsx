...
const features = [
  [WalletCards, 'Post the car you want', 'Tell sellers exactly what you want without browsing stale listings.'],
        ...
        <Container className="grid items-center gap-10 lg:grid-cols-[0.95fr_1.05fr]">
          <div>
            ...
            <p className="mt-5 text-lg leading-8 text-charcoal/70">
              Post the car you want with your budget, location and must-haves. Dealers and sellers respond under one Ready-to-Buy Card so you can compare clearly.
            </p>
