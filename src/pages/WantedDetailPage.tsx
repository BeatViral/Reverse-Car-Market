...
export function WantedDetailPage() {
  ...
  return (
    <section className="section-pad bg-ice">
      <Container>
        <SectionHeader eyebrow="Wanted Card Detail" title={card.title} description="Review criteria, compare dealer and seller responses, then accept, reject, pause or close the card." />
