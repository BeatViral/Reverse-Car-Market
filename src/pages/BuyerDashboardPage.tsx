...
const navItems: Array<[string, string]> = [
  ...
  ['My Wanted Cards', '/buyer/dashboard'],
...
export function BuyerDashboardPage() {
  ...
  return (
    <DashboardShell title="Buyer Dashboard" description="Manage Wanted Cards, compare offers and control when sellers can contact you." navItems={navItems}>
      <div className="grid gap-6">
        <div className="grid gap-4 md:grid-cols-4">
          <StatCard label="Open Wanted Cards" value={String(cards.length || buyerWantedCards.length)} />
        ...
        <div className="rounded-lg bg-white p-5 shadow-soft ring-1 ring-charcoal/10">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              <h2 className="text-2xl font-black text-navy">My Wanted Cards</h2>
